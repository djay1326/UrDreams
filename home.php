    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="nav navbar-nav ">
        ...
        <ul class="dropdown-menu">
          <li><a href="#">Passport and Visa</a></li>
      ...
      <li><h3 style="color:red ;text-decoration: underline;">Welcome <?php echo $_SESSION['clientname']; ?> </h3></li>
    </ul>
	...
	<div class="w-50 m-auto">
		<form action="logged.php" method="post">
			<div class="form-group">
				How can we help you?  :     <select name="choose" >
					<option name="visa">Passport & Visa</option>
					<option name="travel">Travel Support</option>
					<option name="vehicle">Vehicle Rentals</option>
					<option name="hotel">Hotel Stays</option>
					<option name="insurance">Travel Insurance</option>
					<option name="guide">Tour Guide</option>
				</select>
			...
			<button type="submit" class="btn btn-success" onclick="reach()">Submit</button>
		</form>
	</div>
...
<script type="text/javascript">
	function reach(){
		alert ("You've reached us, we will soon get back to you.!!");
	}
</script>
